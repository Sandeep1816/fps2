    ...
    <section className="py-16 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-transparent bg-gradient-to-r from-[#408CFF] to-[#00205B] bg-clip-text mb-8">What Winners Receive</h2>
        </div>
          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-bold text-gray-800 mb-2 text-sm leading-tight">{benefit.title}</h3>
        ...
        <div className="text-center">
          <Button size="lg" className="bg-gradient-to-r from-[#3AC6D9] to-[#408CFF] hover:bg-cyan-500 text-black font-semibold px-8 py-3">
